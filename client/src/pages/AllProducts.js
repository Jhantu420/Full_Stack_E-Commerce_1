          ...
          {Array.isArray(products) &&
            ...
            products.map((item) => (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  {/* Delete Product Icon */}
                  <div className="w-fit bg-red-400 hover:bg-red-700 p-2 rounded-full cursor-pointer text-white">
                    <Link onClick={() => handleDeleteProduct(item._id)}>
                      <MdDelete />
                    </Link>
                  </div>

                  {/* Edit Product Icon */}
                  <div className="w-fit bg-green-400 hover:bg-green-700 p-2 rounded-full cursor-pointer text-white">
